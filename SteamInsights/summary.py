...
def get_sales_info(game_name):
    ...
    ----------
    game_name : str
        The name of the game for which to retrieve sales information.

    Returns
    -------
    pandas.DataFrame
        A DataFrame containing sales details for the specified game.
...
def get_genre(game_name):
    ...
    ----------
    game_name : str
        The name of the game for which to retrieve genre information.

    Returns
    -------
    pandas.DataFrame
        A DataFrame containing genre details for the specified game.
...
def get_tags(game_name):
    ...
    ----------
    game_name : str
        The name of the game for which to retrieve tags.

    Returns
    -------
    List[str]
        A list of tags associated with the specified game.
...
def get_comp_req(game_name):
    ...
    ----------
    game_name : str
        The name of the game for which to retrieve system requirements.

    Returns
    -------
    pandas.DataFrame
        A DataFrame containing system requirements for the specified game.
...
def company_summary(company_name, developer=True):
    ...
    Example
    -------
    >>> company_summary('Electronic Arts', developer=False)
    """
